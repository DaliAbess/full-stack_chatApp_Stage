...
```bash
git clone https://github.com/DaliAbess/full-stack_chatApp.git
```
...
```bash
docker build -t <docker_hub_user>/full-stack_frontend:v1 .
```
...
```bash
docker build -t <docker_hub_user>/full-stack_backend:v1 .
```
